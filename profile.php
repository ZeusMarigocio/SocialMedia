...
<div class = "container" style="margin:0 auto;width:80%;">
					...
					<div class="row">
                        ...
                        <div align="center">
                            ...
                            ?>
                                ...
                                <br><br>
                                <a href="user_uploadphoto.php?id=<?=$id?>" class="btn btn-primary">Update Photo</a>
                            <?php } else{ ?>
                               
                                <img src="user_pics/default.jpg" width = "250" height="200"> 
                                <br><br>
                                        <a href="user_uploadphoto.php?id=<?=$id?>" class = "btn btn-info"> UPLOAD PHOTO </a>
                            ...
                            <br>
                            <br>
                            <a href = "editprofile.php?id=<?=$id?>" class = "btn btn-primary"> Edit Account </a>
                        </div>
    ...
    <div class="container" style = "width:70%;margin:60px auto 0 auto;border-radius:10px;background-color:#2F4F4F" >
        ...
        <div class="container-fluid">
			<div class="panel-heading">
                ...
                <br>
                    ...
                    <form action = "post_proc_profile.php" method = "post">
        ...
        $postquery = "Select post_id,post, date, users.user_id, Photo, Firstname, Middlename, Lastname from users join posts on users.user_id = posts.user_id where  posts.user_id  = '$id' order by date DESC";
